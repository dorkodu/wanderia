import { IconAdOff, IconArrowRight, IconBuildings, IconCheck, IconClock, IconInfinity, IconMail, IconMultiplier2x, IconPin, IconUserHeart, IconUsersGroup, IconWorld, IconX } from "@tabler/icons-react";
  ...
  return (
    <section className="relative py-16 px-6 overflow-hidden">
      <div className="mx-auto max-w-4xl">
        <div className="relative rounded-3xl overflow-hidden p-8 md:p-12 bg-gradient-to-br from-emerald-600 via-cyan-600 to-indigo-600">
          {/* Decorative elements */}
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 text-white">
              <h2 className="text-3xl md:text-4xl font-black tracking-tight text-shadow-sm">
                Supercharge Your{" "}
                <span className="text-emerald-200">Community</span>
              </h2>
              <p className="text-lg text-white/90 leading-relaxed">
                Unlock premium features to scale your regenerative community. Your first week is on us.
              </p>
              <Button
            ...
            <div className="space-y-4">
              {[
                { icon: IconAdOff, title: "Ad-free Experience", description: "No interruptions, full productivity." },
                { icon: IconMultiplier2x, title: "Doubled Gains", description: "More XP, tokens, and rewards." },
                { icon: IconUsersGroup, title: "Unlimited Groups", description: "Create unlimited community spaces." },
              ].map((feature, i) => (
                <div key={i} className="flex items-center gap-4 p-3 rounded-xl bg-white/10 backdrop-blur-sm">
    ...
    <section id="pricing" className="relative py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          {/* Free Tier */}
          <div className="relative rounded-3xl border-2 border-border/50 bg-card p-8 transition-all duration-300 hover:border-emerald-500/30 hover:shadow-xl">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-2">Starter</h3>
              <p className="text-muted-foreground">All the basics for a new beginning</p>
            </div>
          ...
          {/* Premium Tier */}
          <div className="relative rounded-3xl bg-gradient-to-br from-emerald-600 via-cyan-600 to-indigo-600 p-8 text-white shadow-xl shadow-emerald-500/20">
            {/* Popular badge */}
            ...
            <div className="mb-6">
              ...
              <p className="text-white/80">Supercharge your community</p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="rounded-2xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-emerald-500/30">
          ...
          <div className="rounded-2xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-emerald-500/30">
            ...
            <a href="mailto:hey@dorkodu.com" className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-medium hover:underline">
